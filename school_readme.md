...
- [Introduction](#introduction)
    - [App](#app)
    - [Scooter Hardeware](#scooter-hardeware)
    - [Team and Roles](#team-and-roles)
- [Requirements](#requirements)
    - [Software](#software)
    - [Scooter Hardware](#scooter-hardware)
...
- [Business Canvas](#business-canvas)
    - [Key Partners](#key-partners)
       - [Personas from the ScooTec](#personas-from-the-scootec)
...
- [Features](#features)
    ...
    - [Flowdiagramm](#flowdiagramm)
        - [ScooTec GmbH Website](#scootec-gmbh-website)
        - [Sensor Device with the Website](#sensor-device-with-the-website)
    - [Electric Circuit Diagram](#electric-circuit-diagram)
- [Extra](#extra)
    - [Test](#test)
    - [Insterllation](#insterllation)
        - [Arduino on a Pi](#arduino-on-a-pi)
...
- [Viedeo](https://link-url-here.org) UI Tutorial/Show
- [GitLab](https://gitlab.com/itech_ble_nze/lernfeld-2) Schule
- [GitLab](https://gitlab.autonubil.net/noah.zeumer/lernfeld-2) medocino
- [Install GPS USB](http://raspberry.tips/projekte/gps-tracking-mit-dem-raspberry-pi)
- [Install GPS USB YouTube](https://www.youtube.com/watch?v=YggBPZJEX2I)
